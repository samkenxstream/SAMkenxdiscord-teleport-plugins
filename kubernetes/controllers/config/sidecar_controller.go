...
//+kubebuilder:rbac:groups=config.teleport.dev,resources=sidecars,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=config.teleport.dev,resources=sidecars/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=config.teleport.dev,resources=sidecars/finalizers,verbs=update
