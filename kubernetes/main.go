...
import (
	...
	authv9 "github.com/gravitational/teleport-plugins/kubernetes/apis/auth/v9"
	...
	configcontrollers "github.com/gravitational/teleport-plugins/kubernetes/controllers/config"
...
func init() {
	...
	utilruntime.Must(authv9.AddToScheme(scheme))
...
func main() {
	...
	if err = (&configcontrollers.SidecarReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
